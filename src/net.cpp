...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Amigacoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"seed1.agacoin.dk", "seed1.agacoin.dk"},
//    {"amigacoinpool.org", "dnsseed.amigacoinpool.org"},
    {"seed2.agacoin.dk", "seed2.agacoin.dk"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Amigacoin is probably already running."), addrBind.ToString().c_str());
        else
